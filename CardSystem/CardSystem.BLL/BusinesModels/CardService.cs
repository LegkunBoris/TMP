...
namespace CardSystem.BLL
{
	public class CardService : ICardService
	{
		...
		//Validating answer
		public bool ValidateAnswer(CardDTO cardDTO)
		{
			Mapper.Initialize(cfg => cfg.CreateMap<CardDTO, Card>());
			var cardD = Mapper.Map<CardDTO, Card>(cardDTO);

			var card = Database.Cards.Get(cardD.CardId);
			if (card.Translate != cardD.Translate)
				return false;
			return true;
